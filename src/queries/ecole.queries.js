...
const addEcole = "INSERT INTO ecole (nom, programme_educatifs, activites, resultats, raison_sociale, niveau_id, classes, geom, departement_id, commune_id, arrondissement_id, quartier_id  ) VALUES ($1, $2, $3, $4, $5, $6, $7, ST_SetSRID(ST_MakePoint($8, $9), 4326), $10, $11, $12, $13 )";

const deleteEcole = "DELETE FROM ecole WHERE id = $1";

const updateEcole = "UPDATE ecole SET nom = $1, programme_educatifs = $2, activites = $3, resultats = $4, raison_sociale = $5, niveau_id = $6, classes = $7, departement_id = $8, commune_id = $9, arrondissement_id = $10, quartier_id = $11  WHERE id = $12";
