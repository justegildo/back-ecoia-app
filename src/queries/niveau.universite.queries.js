...
const addNiveauUniversite = "INSERT INTO niveau_universite (label, name) VALUES ($1, $2)";

const deleteNiveauUniversite = "DELETE FROM niveau_universite WHERE id = $1";

const updateNiveauUniversite = "UPDATE niveau_universite SET label = $1, name = $2 WHERE id = $3";
